...
\begin{center}
  ...
  \medskip
  {E-mail: jsxzjh@gmail.com, Tel: +86 185-9191-5931, http://xzjh.org}\\
  \smallskip
  {P.O.~Box 0109, Xidian Univ., No.266 Xifeng Rd., Chang'an District, Xi'an, P.R.~China, 710126}
...
\begin{rSection}{Education}
  \vspace{-1.5em}
  \item
    \shadedsection{\period{{\bf Xidian University}, {\em Xi'an, P.R.~China}}{Sep.~2010}{Jun.~2014 (Expected)}}\\
    {\bf Bachelor of Science}, {\em Computer Science and Technology}\\
    \detail{GPA: 85/100 overall, 89/100 major}\\
    \detail{Scholarship: Xidian University Scholarship 2011 - 2013, CASIC Scholarship 2012}
\end{rSection}
...
\begin{rSection}{Work Experience}
  \vspace{-1.5em}
  \item
    \shadedsection{\period{{\bf Microsoft Research Asia (MSRA)}, {\em Beijing, P.R.~China}}{Jul.~2013}{Present}}\\
    ...
    \detail{{\em See more details at {\bf FaceSwap for Windows 8} in {\bf Main Projects} section.}}
\end{rSection}
...
\begin{rSection}{Publication}
  \vspace{-1.5em}
    \item
      {\bf Jiaheng Zhang}, Nianqi Hou, Jiazhi Xiong, Fei Xing and Huming Zhu (2013). {\bf A Solution for Speeding up Non-local Means Denoising Algorithm by GPU}. {\em HPC China (National Annual Conference on High Performance Computing).}
\end{rSection}
...
\begin{rSection}{Main Projects}
  \vspace{-1.5em}
  \item
    \shadedsection{\period{\bf FaceSwap}{Jul.~2013}{Oct.~2013}}\\
...
\begin{rSection}{Main Honors}
  ...
  \item
    ...
    \detail{Awarded for the best performance in creative solution, UI/UX designing, market promotion and onsite demonstration in the competition of Microsoft Student Challenge 2012.}\\
...
\begin{rSection}{Academic Conferences}
  \vspace{-1.5em}
  \item
...
\begin{rSection}{Leadership \& Activities}
  \vspace{-1.5em}
  \item
    \organization{President}{Microsoft Technology Club (MSTC) in Xidian Univ.}{Jul.~2012 - Jun.~2013}
    ...
    \detail{Presided over the daily work of the club, organized technical lectures, exchange meetings and academic competitions in the university;}\\
    ...
    \detail{Gave lessons on foundation of C\# programming language.}\\
...
\begin{rSection}{Skills}
  \vspace{-1.5em}
  \item
\skill{Languages}{C, C++, C\#, Java, VB, Matlab, Python, PHP, SQL}\\
\skill{Platforms}{GPU Programming, Windows, Android, Windows Phone, Windows 8 Development, Linux}\\
\skill{Tools}{Visual Studio, Git, Vim, Photoshop, Lightroom, \LaTeX, Microsoft Office, MySQL}\\
